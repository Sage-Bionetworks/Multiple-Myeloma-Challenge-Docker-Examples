...
## Read in the annotation file for Sub-Challenge 1
anno.filename <- "/test-data/sc1_Validation_ClinAnnotations.csv"
cat(paste0("\nReading in annotation file ", anno.filename, "\n"))
anno.tbl <- fread(anno.filename)

## Use age as our prediction score--i.e., assume that higher age 
